...
def add_song_to_playlist(playlist_id):
    ...
    # Populate the choices for the form with songs not already on this playlist
    form.song.choices = [(song.id, song.title) for song in Song.query.filter(Song.id.notin_(playlist.songs))]
    if form.validate_on_submit():
